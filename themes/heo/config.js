const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2026-09-20', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: '/' },
    { title: '专注 AI、机器学习、深度学习开发', url: '/about' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '专注 AI',
  HEO_HERO_TITLE_2: '与智能体开发',
  HEO_HERO_TITLE_3: 'PHCLAW',
  HEO_HERO_TITLE_4: 'AI开发者',
  HEO_HERO_TITLE_5: '4年经验 · 大模型微调 · VLM · 知识库',
  HEO_HERO_TITLE_LINK: 'https://github.com/PHclaw',
  // 英雄区遮罩文字
  ...
  HEO_SOCIAL_CARD_TITLE_2: '访问我的GitHub查看更多项目',
  HEO_SOCIAL_CARD_TITLE_3: '访问GitHub',
  HEO_SOCIAL_CARD_URL: 'https://github.com/PHclaw',
